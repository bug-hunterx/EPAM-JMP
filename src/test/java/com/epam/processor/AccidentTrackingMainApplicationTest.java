...
public class AccidentTrackingMainApplicationTest {
    ...
    private MockMvc mvc;
    private static HsqlInit hsqlInit;
   ...
   /* @Test
    ...
    public void should_update_accidentRecord() throws Exception {
        ...
        roadAccident.setDayOfWeek(1);

        mvc.perform(put("/accidents/roadAccident").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType("application/json;charset=UTF-8"));

        mvc.perform(get("/accidents/200901BS70002").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void should_delete_accidentRecord() throws Exception {
        mvc.perform(delete("/accidents/200901BS70001").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());

        mvc.perform(get("/accidents/200901BS70001").accept(MediaType.APPLICATION_JSON))
